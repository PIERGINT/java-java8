...
public class DateAndTime_02_Test {
    ...
    public void test_localDate_format() {
        ...
        String result = localdate.format(DateTimeFormatter.ofPattern("11 - 03 - 2015"));
    ...
    public void test_with() {
    	...
    	LocalDate newLocalDate2 = newLocalDate1.with(ChronoField.DAY_OF_MONTH, 5);
    	
    	LocalDate result = newLocalDate2.plus(1, ChronoUnit.MONTHS);
